...
pub use snippets::load_builtin_locales;
...
mod locales_tests {
    ...
    fn common_ftl_error_keys_en() {
        ...
        assert_eq!(i18n.t("error-connection-failed"), "Connection failed");
        assert_eq!(i18n.t("error-parse-failed"), "Parse error");
    }
